---
title: "EdgeCDN-X DNS Platform - Global Load Balancing at Scale"
date: 2026-09-15
tags:
  - dns
  - gslb
...
*Read more about EdgeCDN-X DNS routing in our [CoreDNS documentation](https://edgecdn-x.github.io/coredns)*
...
```text
EdgeCDN-X is evolving into a full-fledged Global Server Load Balancer (GSLB) platform, powered by CoreDNS and Kubernetes-native routing.

What makes it different?
✓ Intelligent routing by IP prefix, geolocation & health status
...
Read more: https://edgecdn-x.github.io/coredns
