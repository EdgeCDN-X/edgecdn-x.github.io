...
*Learn more about our DNS controller and GSLB capabilities → [CoreDNS Platform Guide](https://edgecdn-x.github.io/coredns)*
...
Learn more: https://edgecdn-x.github.io/coredns
...
https://edgecdn-x.github.io/coredns
```
